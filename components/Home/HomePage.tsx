  ...
  return (
    <div>
      <section
        ...
        style={{ backgroundImage: `url('/banner-l.png')` }}
        aria-label="Hero"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">{stats.totalStudents}+</h2>
            ...
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">{stats.totalInstructors}+</h2>
      ...
      <section
           ...
           aria-label="Why choose S@Learn"
             >

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Why Choose S@Learn?</h2>
